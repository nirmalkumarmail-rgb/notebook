      ...
      <div className="editor-toolbar">
        ...
        {!preview && (
          <div className="format-toolbar">
            <button className="fmt-btn" title="Bold (select text first)" onMouseDown={(e) => { e.preventDefault(); insertAround('**', '**', 'bold text'); }}>
              <strong>B</strong>
            </button>
            <button className="fmt-btn fmt-italic" title="Italic (select text first)" onMouseDown={(e) => { e.preventDefault(); insertAround('*', '*', 'italic text'); }}>
              <em>I</em>
            </button>
        ...
        <button
          className={`btn-icon${preview ? ' btn-active' : ''}`}
          onClick={() => setPreview(!preview)}
          title={preview ? 'Back to edit' : 'Preview markdown'}
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
